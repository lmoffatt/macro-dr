...
enum MOMENTS {COUNT,SUM,SUM_SQR,MEAN,VARIANCE};

const std::string MOMENTS_string[]={"count","sum","sum_sqr","mean", "variance"};

constexpr MOMENTS MOMENTS_VALUES[]={COUNT,SUM,SUM_SQR,MEAN,VARIANCE};
