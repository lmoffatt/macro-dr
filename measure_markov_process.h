...
void actualize_mp(measure_algorithm_state& current,markov_process<std::size_t>& mp,const Model& m,X new_x,std::size_t actual_nsubsamples)
{
...
auto init_mp(std::mt19937_64& mt,const Model& m, X x, std::size_t nsamples)
{
...
auto measure_point(measure_algorithm_state& current,const F& f,std::mt19937_64& mt,markov_process<std::size_t>& mp,const Model& m, const Point<X,Y>& in_point,  std::size_t desired_nsubsamples)
{
