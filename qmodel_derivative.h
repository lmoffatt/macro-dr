...
template<>
class Derivative<Allosteric_Model>: public Allosteric_Model
{
public:
...
public:
    ...
    Derivative(std::size_t number_of_units,
        ...
        base_type(number_of_units,conformational_changes,unit_of_conformational_changes,conformational_interactions,conductance_names){}
    ...
    Derivative(const std::vector<std::string>& conformational_changes,
        ...
        base_type{conformational_changes,conformational_changes_names,agonist_changes,conductance_changes,conductance_names,conformational_inter_unit_cell}{}


    template <class Parameter>
    static Derivative<double> rate(const transitions& tr,const Derivative<Parameter>& p)
    {
    ...
    auto Qs(const Derivative<Parameters>& p) const
    {

        M_Matrix<Derivative<double>> Q0(conformer_.size(),conformer_.size(),Matrix_TYPE::FULL,Derivative<double>(p.x()));
        M_Matrix<Derivative<double>> Qa(conformer_.size(),conformer_.size(),Matrix_TYPE::FULL,Derivative<double>(p.x()));
