...
public:
    ...
    using evidence::FIM_Model<Markov_Model_Likelihood<Model>,Experiment>::compute_DLikelihood;
    using evidence::FIM_Model<Markov_Model_Likelihood<Model>,Experiment>::compute_Likelihood;
